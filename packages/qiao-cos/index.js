...
const init = (config) => {
    ...
    // upload
    app.uploadFile = (dest, source, cb) => { uploadFile(app, dest, source, cb); };
    app.uploadFileSync = async (dest, source) => { return await uploadFileSync(app, dest, source); };
    app.uploadFolder = (destFolder, sourceFolder, cb) => { uploadFolder(app, destFolder, sourceFolder, cb); };
    app.uploadFolderSync = async (destFolder, sourceFolder) => { return await uploadFolderSync(app, destFolder, sourceFolder); };
